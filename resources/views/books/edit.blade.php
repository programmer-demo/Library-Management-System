                ...
                <form action="{{ route('book.update' , $book->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="barcode" value="{{$book->barcode}}" name="barcode" placeholder="Enter Barcode" required>
                        </div>
                        <div class="col-6">
                            <label for="name" class="mb-2">Name</label>
                            <input type="text" class="form-control" id="name" value="{{$book->name}}" name="name" placeholder="Enter Name" required>
                        </div>
                        <div class="col-6 mt-4">
                            <label for="author" class="mb-2">Author</label>
                            <input type="text" class="form-control" id="author" value="{{$book->author}}" name="author" placeholder="Enter Author" required>
                        </div>
                        <div class="col-6 mt-4">
