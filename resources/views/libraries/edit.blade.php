                ...
                <form action="{{ route('library.update' , $library->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="student_idcard" value="{{ $library->student->id_card }}" name="student_idcard" placeholder="Enter ID Card" required>
                        </div>
                        <div class="col-6">
                            <label for="student_name" class="mb-2">Name</label>
                            <input type="text" class="form-control" id="student_name" name="student_name" value="{{ $library->student->name }}" placeholder="Enter Name" required>
                        </div>
                        <div class="col-6 mt-4">
                            ...
                            <select id="student_gender" name="student_gender" class="form-select" required>
                                <option value="Male" @if ($library->student->gender == "Male") selected @endif>Male</option>
                                <option value="Female" @if ($library->student->gender == "Female") selected @endif>Female</option>
                            </select>
                        </div>
                        <div class="col-6 mt-4">
                            <label for="student_faculty" class="mb-2">Faculty</label>
                            <input type="text" class="form-control" id="student_faculty" value="{{ $library->student->faculty }}" name="student_faculty" placeholder="Enter Faculty" required>
                        </div>
                    </div>
